...
final public class IterativeBoseNelson extends Sort {
    public IterativeBoseNelson(ArrayVisualizer arrayVisualizer) {
	...
	private void compSwap(int[] array, int a, int b) {
		...
		if(Reads.compareIndices(array, a, b, 0.2, true) == 1)
			Writes.swap(array, a, b, 0.2, false, false);
	}
